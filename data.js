...
window.SIM = {
  ...
  perks: {
    ...
    list: [
      { good: '서명 한 번으로 끝난다',
        why: '네트워크를 오가며 여러 번 거래를 보내는 일은 솔버가 맡는다' },
      { good: '받을 쪽 가스를 챙기지 않아도 된다',
        why: '그 네트워크에서 내주는 것은 솔버의 자산이다' },
      { good: '기다리는 시간이 줄어들 수 있다',
        why: '정산이 끝나기를 기다리지 않고 솔버가 먼저 내주기 때문이다' },
      { good: '경로를 고르지 않아도 된다',
        why: '어디를 거칠지는 솔버가 푼다. 나는 원하는 결과만 말한다' },
      { good: '받을 최소 수량은 내가 정한다',
        why: '그 아래로는 거래가 성립하지 않는다' }
    ]
  },
